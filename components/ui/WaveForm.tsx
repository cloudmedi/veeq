      ...
      >
        <div
          ...
          style={{
            ...
            opacity: firstLoad ? 0.8 : 1,
          }}
          className={`${
            firstLoad ? "invisible hidden" : "visible flex"
          } w-10 h-10 rounded-full cursor-pointer bg-slate-700 flex justify-center items-center`}
        >
          <FontAwesomeIcon
        ...
        <div
          className={`${firstLoad ? "invisible hidden" : "visible block"} ml-3`}
          ref={containerRef}
        />
      </WaveSurferWrap>
    </>
